...
var Post = (_dec = (0, _typeorm.Entity)('posts'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('text'), _dec4 = (0, _typeorm.Column)('text'), _dec(_class = (_class2 = (_temp = //Partial<Post> 表示不必把所有Post的属性都传过来
...
// ){}
// public 是ts的语法，约等于 this.title = title
